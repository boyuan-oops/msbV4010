...
class TestAddtopic:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('帖子内容不能大于140个字符！', {"text": "111111111011111111101111111110111111111011111111101111111110111111111011111111101111111110111111111011111111101111111110111111111011111111101","category_id": "1"}),
            ...
            ('待定', {'text': '12345','category_id': '2','images': '[{"image_url": "https://image2.meishubao.com/2021-02-08/3591d031c096474520bad8b502cf9dad.jpg","image_width": "838", "image_height": "1146"}]'}),
            ('待定',{})
        ]
    )
